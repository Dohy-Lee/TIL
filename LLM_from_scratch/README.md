...
|---|---|---|
| 01 | LLM 개요 | 
| 02 | 텍스트 데이터 다루기 | [정리](./Step0%29%20Text_preprocess.ipynb) |
| 03 | 어텐션 메커니즘 | [정리](./Step1%29%20Attention.ipynb) |
| 04 | GPT 모델 구현 | [정리](./Step2%29%20Transformer_Decoder.ipynb) |
| 05 | 사전학습 | [정리](./Step3%29%20Pretraining.ipynb) |
| 06 | 분류 파인튜닝 | [정리](./Step4%29%20Finetuning(Classification).ipynb) |
| 07 | 지시 파인튜닝 | [정리](./Step5%29%20Finetuning(Instruction).ipynb) |
| 08 | 부록 | [정리](./Appendix.ipynb) |
